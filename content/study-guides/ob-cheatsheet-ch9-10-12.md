# OB Cheat Sheet: Postpartum & Newborn Care, Complications
...
**BUBBLE** — Postpartum assessment
**REEDA** — Perineum healing (Redness, Edema, Ecchymosis, Discharge, Approximation)
**4 T's** — PPH causes (Tone, Trauma, Tissue, Thrombin)
**VEAL CHOP** — FHR decelerations (from Ch 6-8)
**4 P's** — Labor factors (from Ch 6-8)
